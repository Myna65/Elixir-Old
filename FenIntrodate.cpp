...
#include "ui_ImpJournalVente.h"
FenIntrodate::FenIntrodate()
{
	ui=new Ui::ChoixDates();
	ui->setupUi(this);
...
QDate FenIntrodate::PreDate()
{
	return ui->duDateEdit->date();
}
QDate FenIntrodate::SecDate()
{
	return ui->auDateEdit->date();
}
